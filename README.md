...
8. The private keys for the bots are stored in the /app/data/channels file.  If you would like to add pictures for your bots you can log into Nostr using these private keys and edit the bot profiles.
