                ...
                let event = nostr_bot::Event::new(
                    ...
                    format!(
                        r#"{{
                            "name":"{}",
                            "display_name":"{}",
                            "about":"{} \n\nDiscord feed generated by [dostr](https://github.com/MiningSC/dostr) bot.",
                            "picture":"{}",
                            "banner":"{}",
                            "nip05":"{}@{}"
                        }}"#,
                        channel_name, display_name, about, pfp, banner, channel_name, &config.domain
                    ),
                );
            ...
            let event = nostr_bot::Event::new(
                ...
                format!(
                    r#"{{
                        "name":"{}",
                        "display_name":"{}",
                        "about":"{} \n\nTwitter feed generated by [dostr](https://github.com/MiningSC/dostr) bot.",
                        "picture":"{}",
                        "banner":"{}",
                        "nip05":"{}@{}"
                    }}"#,
